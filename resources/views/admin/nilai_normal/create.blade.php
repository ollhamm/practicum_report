            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-sm">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Tambah Nilai Normal</h2>
                    ...
                    <form action="{{ route('admin.nilai-normal.store') }}" method="POST" class="space-y-6" id="nilaiNormalForm">
                        @csrf
