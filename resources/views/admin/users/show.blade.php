                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-3">
                                    <span class="p-1 text-sm font-medium rounded-sm
                                        {{ $user->approved_by_admin === 2 ? 'bg-green-500 text-white' : 
                                           ($user->approved_by_admin === 1 ? 'bg-red-500 text-white' : 
                                            'bg-yellow-500 text-white') }}">
                                        {{ $user->getApprovalStatusText() }}
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm font-medium">{{ $user->name }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">{{ $user->email }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm capitalize">{{ $user->role }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm font-mono">{{ $user->nip }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">
                                            {{ $user->tempat_lahir }}, {{ $user->tanggal_lahir ? date('d F Y', strtotime($user->tanggal_lahir)) : '-' }}
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">{{ $user->agama ?? '-' }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">{{ $user->nomor_telepon ?? '-' }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">{{ $user->alamat_ktp ?? '-' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm">
                                            {{ $user->updated_at ? \Carbon\Carbon::parse($user->updated_at)->locale('id')->translatedFormat('l, d F Y') : '-' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
